...
public class ResultatResponse {
    ...
    public String getNomGuanyador() { return nomGuanyador; }
    public void setNomGuanyador(String nomGuanyador) { this.nomGuanyador = nomGuanyador; }

    public String getPerdedorId() { return perdedorId; }
    public void setPerdedorId(String perdedorId) { this.perdedorId = perdedorId; }

    public String getNomPerdedor() { return nomPerdedor; }
    public void setNomPerdedor(String nomPerdedor) { this.nomPerdedor = nomPerdedor; }
